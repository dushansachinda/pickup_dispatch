...
<%
    ...
    String error = (String) currentSession.getAttribute(OAuth2Constants.ERROR);
    String error2 = (String) request.getAttribute(OAuth2Constants.ERROR);
%>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-sm-9 col-md-4 col-lg-4 mx-auto login-sec">
                ...
                <%if(error != null && !error.isEmpty()){ %>  
                   <h6 style="color:red; background-color: rgb(143, 188, 143);">
                       You are not allowed to login due to insufficient privileges, Please contact Administrator: Reason-> [<%=error %>]
                   </h6>
                <%} %>
